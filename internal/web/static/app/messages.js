export const MESSAGES = {
  en: {
    ...
    "settings.actionHelp": "Move needs a target folder. Run Command needs command text. Delete and Restore do not use extra fields.",
  ...
  "zh-CN": {
    ...
    "settings.actionHelp": "移动需要目标文件夹，执行命令需要命令行，删除和恢复不需要额外字段。",
