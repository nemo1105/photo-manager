export const MESSAGES = {
  en: {
    ...
    "settings.actionHelp": "Move needs both an alias and target folder. Run Command needs both an alias and command text. Delete and Restore do not use extra fields.",
    ...
    "settings.commandPlaceholder": "python script.py",
  ...
  "zh-CN": {
    ...
    "settings.actionHelp": "移动需要别名和目标文件夹，执行命令需要别名和命令行，删除和恢复不需要额外字段。",
    ...
    "settings.commandPlaceholder": "例如 python script.py",
